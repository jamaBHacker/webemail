...
?>
  ...
  <tr bgcolor = "#ff6600">
  <td bgcolor = "#ff6600" width = 103><img src = "<?php echo base_url('images/webemail/warm-mail.gif'); ?>" 
...
?>
  ...
  <tr>
  <td bgcolor = "#ff6600" align = right><img src = '<?php echo base_url("images/webemail/warm-mail.gif");?>'
...
function display_account_select($auth_user, $selected_account)
{
  ...
  if($accounts>1)
  {
    ...
    for($i = 0; $i<$accounts; $i++)
    {
      ...
      echo "<option value = '?action=select-account&account=".$list[$i]."'";
...
?>
  <center>
  <form method=post action="<?php echo base_url('index.php/webemail?action=store-settings'); ?>">
   ...
   <?php if($accountid>0) 
      {
        ...
        echo '</td>';
        echo '</form>';
        echo '<form action = "'.base_url().'index.php/webemail?action=delete-account" method = "post">';
...
?>
  <center>
  <form method="post" action="<?php echo base_url('index.php/webemail?action=$action');?>">
...
function display_form_button($button)
{
  ...
  echo "<input type = 'image' src = '".base_url('images/webemail')."/".$button.".gif' border = 0 ";
...
function display_spacer()
{
  ...
  echo '<img src = "'.base_url("images/webemail/spacer.gif").'" border = 0 ';
  echo 'width = 149 height = 43 ';
  echo 'alt = "" />';
}
...
?>
  ...
  <form action = "<?php echo base_url('index.php/webmail?action=send-message');?>" method = "post">
  <tr>
    <td bgcolor = "#cccccc">
      To Address:
    </td>
